...
exports.hasHooks = function (newInstance) {
    return function (Model) {
        Model.DAO.prototype.hooks = function hooks() {
            this._hooks = this._hooks || newInstance().curry(this);
            return this._hooks;
        };

        Model.DAO.prototype.runHook = function runHook(event) {
            return this.hooks().runHook.apply(this._hooks, arguments);
        };

        Model.DAO.prototype.on = function on(event, listener) {
...
exports.register = function (server, opts, next) {
    ...
    server.handler('db.query', require('./query-handler')(sequelize, opts.queryHandler));
    server.handler('db.lookup', require('./lookup-handler')(sequelize));
    server.handler('db.remove', require('./remove-handler')(sequelize, opts.deleteHandler));
    server.handler('db.update', require('./update-handler')(sequelize));
